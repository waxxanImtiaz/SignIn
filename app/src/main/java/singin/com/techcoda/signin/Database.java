...
//    public long insertVisitor(String companyID, String firstName, String lastName){
    public long insertVisitor(List<String> siginIn, byte[] b,byte[] sign){
        ...
        temp = siginIn.get(11);
//        contentValues.put(DatabaseHandler.COL_SIGNATRUE_CAPTURE, sign);
